...
python examples/feffi_lid-driven-cavity.py --nu 2.5e-4 --store-sol --plot-path "LDC_2.5e-40"
python examples/feffi_lid-driven-cavity.py --nu 1e-4 --store-sol --plot-path "LDC_1e-4"
...
python examples/feffi_buoyancy-driven-cavity.py --beta 1000000 --steps-n 350 --store-sol --plot-path "BDC_1000000"

python examples/feffi_buoyancy-driven-cavity.py --config-file "feffi/config/rayleigh-benard-convection.yml" --beta 2500 --steps-n 350 --store-sol --plot-path "RBC_2500" 
