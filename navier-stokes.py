...
def define_function_spaces():
	...
	T_n, T_ = Function(T_space), Function(T_space)
	S_n, S_ = Function(S_space), Function(S_space)
...
def plot_solution():
	...
	p_to_plot = p_ - rho_0*g*y #p is redefined in variational problem to include a rho_0*g*y term
