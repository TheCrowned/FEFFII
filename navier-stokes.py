...
def boundary_conditions():
	...
	if(args.domain == 'square'):
		...
		bcp.append(DirichletBC(Q, Constant(0), "near(x[1], 0) && x[0] < 0.2")) #applying BC on right corner yields problems
...
if __name__ == '__main__':
	...
	nu = Constant(0.01)#3.6*10**-1)
	g = 1.27*10**5
	rho_0 = Constant(1)#1.323*10**4) #https://en.wikipedia.org/wiki/Seawater#/media/File:WaterDensitySalinity.png
	alpha = Constant(10**(-4))
